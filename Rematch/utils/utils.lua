...
function rematch.utils:SpoolText(editbox,text,highlight)
    ...
    if averageWidth > 100 then -- for very long texts (backed up teams) do one line at a time
        chunkSize = C.EXPORT_CHUNK_SLOW
    elseif totalWidth/maxLines > 25 then -- for moderate texts (csv pet export) do two lines at a time
