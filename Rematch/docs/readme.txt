...
This is a beta version that will replace the existing release version at this link once the beta ends on November 7, 2023:
...
From the start, Rematch was built to work independently as its own window detached from the journal. As a standalone window, Rematch has several benefits:
...
- Clicking this button will reload your currently-loaded team. Tthis can be useful if you have a random pet in a slot and you want to pick another random pet.
