...
rematch.optionsList = {
	...
	{type="check", group=9, text=L["Reverse Toolbar Buttons"], var="ReverseToolbar", func="ReverseToolbar", tooltip=L["Reverse the order of the toolbar buttons (Revive Battle Pets, Battle Pet Bandages, Safari Hat, etc)."]},
	...
	{type="check", group=10, text=L["Always Show Team Tabs"], var="AlwaysTeamTabs", func="AlwaysTeamTabs", tooltip=L["Show team tabs along the right side of the window even if you're not on the team panel."]},
	...
	{type="check", group=15, text=L["Hide Extra Help"], var="HideMenuHelp", func="UpdatePetCard", tooltip=L["Hide the informational \"Help\" items found in many menus and on the pet card."]},
