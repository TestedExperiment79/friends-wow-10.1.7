...
rematch.events:Register(rematch.importDialog,"PLAYER_LOGIN",function(self)
    ...
    rematch.dialog:Register("ImportTeams",{
        ...
        layouts = {
            ...
            SingleTeam = {"Text","MultiLineEditBox","CheckButton","GroupSelect"},
            SingleTeamConflict = {"Text","MultiLineEditBox","CheckButton","GroupSelect","Feedback","ConflictRadios"},
...
function rematch.importDialog:UpdateLayout()
    local numGroups,numTeams,numConflicts,numBad = rematch.teamStrings:AnalyzeImport(self.MultiLineEditBox:GetText())
